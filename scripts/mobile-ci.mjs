...
const profiles = {
  staging: { scheme: "Crew Staging", bundleId: "ai.ashler.crew.staging", build: "23", suffix: "-Staging", name: "Crew-Staging" },
  production: { scheme: "Comet", bundleId: "ai.ashler.crew", build: "17", suffix: "", name: "Crew" },
};
