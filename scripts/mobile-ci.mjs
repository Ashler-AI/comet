...
const profiles = {
  staging: { scheme: "Crew Staging", bundleId: "ai.ashler.crew.staging", build: "19", suffix: "-Staging", name: "Crew-Staging" },
  production: { scheme: "Comet", bundleId: "ai.ashler.crew", build: "13", suffix: "", name: "Crew" },
};
