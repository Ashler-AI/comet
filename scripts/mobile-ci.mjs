...
const profiles = {
  staging: { scheme: "Crew Staging", bundleId: "ai.ashler.crew.staging", build: "16", suffix: "-Staging", name: "Crew-Staging" },
  production: { scheme: "Comet", bundleId: "ai.ashler.crew", build: "10", suffix: "", name: "Crew" },
};
