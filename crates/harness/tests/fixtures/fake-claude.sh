...
*scenario:happy*)
  ...
  emit '{"type":"user","parent_tool_use_id":null,"message":{"content":[{"type":"tool_result","tool_use_id":"tool-1","is_error":false,"content":"total 0"},{"type":"tool_result","tool_use_id":"tool-2","is_error":true}]}}'
